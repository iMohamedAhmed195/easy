...
Future<void> handleFirebaseForeground(RemoteMessage message) async {
  ...
  if (message.notification != null) {
    ...
    if (message.data["type"] == "chat") {
      // AppService().getBlocData<ChatCubit>().getMessageFromFirebase(fromFirebase: message.data);
    } else {
      // AppService().getBlocData<OrderCubit>().getOrder();
      // AppService()
...
/*  if (message.notification != null) {
    ...
    */ /* Routes.bottomNavigationRoute.moveTo();
    AppService().getBlocData<OrderCubit>().getOrderDetails(orderId: message.data["order_id"].toString().toInt);
*/ /*
  }*/
}
